...
class RabbitHoleEndpoint(AbstractEndpoint):
    ...
    async def post_file(
        ...
        async with self.get_async_http_client(agent_id) as client:
            return await client.post(self.prefix, data=data)
    ...
    async def post_files(
        ...
        async with self.get_async_http_client(agent_id) as client:
            return await client.post(f"{self.prefix}/batch", data=data)
    ...
    async def post_web(
        ...
        async with self.get_async_http_client(agent_id) as client:
            return await client.post(f"{self.prefix}/web", json=payload)
    ...
    async def post_memory(
        ...
        async with self.get_async_http_client(agent_id) as client:
            return await client.post(f"{self.prefix}/memory", data=data)
